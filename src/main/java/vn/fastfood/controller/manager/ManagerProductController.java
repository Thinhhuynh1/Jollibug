...
public class ManagerProductController {
    ...
    ManagerProductController(DanhMucRepository danhMucRepository, ProductService productService) {
    ...
    public String getProductsPage(Model model,
        ...
        model.addAttribute("listMonAn",
                productService.searchProducts(categoryID, keyword, filter, status));
    ...
    public String postProductsCreate(
            ...
            @RequestParam(value = "donVi", required = false, defaultValue = "phần") String donVi,
            @RequestParam(value = "productFile", required = false) MultipartFile productFile,
            @RequestParam("available") boolean available,
            RedirectAttributes redirectAttributes) {
        try {
            productService.createProduct(buildRequest(tenMon, maDM, gia, soLuongTon, moTa, donVi, available), productFile);
    ...
    public String postProductsUpdate(
            ...
            RedirectAttributes redirectAttributes) {
        try {
            productService.updateProduct(productID, buildRequest(tenMon, maDM, gia, soLuongTon, moTa, donVi, available),
                    productFile);
    ...
    private ProductRequest buildRequest(String tenMon, Long maDM, long gia, long soLuongTon, String moTa,
            String donVi, boolean available) {
