...
<head>
  ...
  <title>Jollibug | Thêm mới danh mục</title>
  <meta name="description" content="Jollibug Manager - thêm mới danh mục món ăn và cấu hình trạng thái hiển thị." />
          ...
          <section class="profile-section">
            ...
            <form action="#" method="post" class="profile-form">
              ...
              <div class="profile-actions" style="display:flex; justify-content:flex-end; gap:0.75rem; margin-top:2rem;">
                ...
                <button type="submit" class="profile-submit" style="max-width:180px;">Lưu danh mục</button>
              </div>
            </form>
          </section>
        </section>
