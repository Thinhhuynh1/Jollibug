...
<head>
    ...
    <title>Jollibug | Thêm món ăn</title>
    <link rel="stylesheet" href="<c:url value='/css/global.css'/>" />
    <link rel="stylesheet" href="<c:url value='/css/components.css'/>" />
    <link rel="stylesheet" href="<c:url value='/css/admin.css'/>" />
    <link rel="stylesheet" href="<c:url value='/css/client/profile.css'/>" />
    <style>
      #productPreview { display:none; max-width:200px; max-height:200px; border-radius:8px; margin-top:0.5rem; object-fit:cover; border:1px solid #e5e7eb; }
    </style>
</head>
            ...
            <div style="max-width:52rem; margin:0 auto; width:100%;">
                <section class="profile-content">
                    <section class="profile-section">
                        <h1 class="profile-title">Thêm món ăn mới</h1>
                        <p class="profile-subtitle">Điền thông tin món, chọn danh mục và tải ảnh (tùy chọn).</p>
                        <form action="<c:url value='/manager/products/create'/>" method="post" enctype="multipart/form-data"
                              class="profile-form" data-product-form>
                            <div class="profile-grid">
                                <label class="profile-field">
                                    <span>Tên món ăn <span style="color:var(--color-red-500);">*</span></span>
                                    <input type="text" name="tenMon" placeholder="Ví dụ: Burger bò phô mai" required />
                                </label>
                                <label class="profile-field">
                                ...
                                <label class="profile-field">
                                    ...
                                    <input type="number" name="gia" min="0" step="1000" placeholder="59000" required />
                                </label>
                                <label class="profile-field">
                                ...
                                <label class="profile-field" style="grid-column:1/-1;">
                                    <span>Mô tả</span>
                                    <textarea name="moTa" rows="3" placeholder="Mô tả ngắn về món ăn..." style="width:100%; resize:vertical;"></textarea>
                                </label>
                                <label class="profile-field" style="grid-column:1/-1;">
                                    <span>Ảnh món ăn</span>
                                    <input id="productFile" type="file" name="productFile" accept="image/*" />
                                    <img id="productPreview" src="" alt="Xem trước ảnh" />
                                </label>
                            </div>
                            <div class="profile-actions" style="display:flex; justify-content:flex-end; gap:0.75rem; margin-top:2rem;">
                                ...
                                <button type="submit" class="profile-submit" style="max-width:180px;">Lưu món ăn</button>
                            </div>
                        </form>
                    </section>
                </section>
