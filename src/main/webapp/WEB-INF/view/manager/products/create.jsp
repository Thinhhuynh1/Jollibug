...
<head>
	...
	<meta name="description" content="Jollibug Manager - thêm mới sản phẩm vào menu." />
						...
						<form action="#" method="post" class="profile-form">
							<div class="profile-grid">
								<label class="profile-field">
									...
									<input type="text" name="name" placeholder="Ví dụ: Burger đôi khói" required />
								</label>
								...
								<label class="profile-field">
									...
									<input type="number" name="price" placeholder="Ví dụ: 249000" />
								</label>

								<label class="profile-field">
									<span>Tồn kho</span>
									<input type="number" name="stock" placeholder="Ví dụ: 36" />
								</label>
