...
<head>
	...
	<title>Jollibug | Xóa khuyến mãi</title>
	<meta name="description" content="Jollibug Manager - xác nhận xóa khuyến mãi." />
			...
			<div style="max-width:52rem; margin:0 auto; width:100%;">
				<section class="profile-content">
					<section class="profile-section">
						<h1 class="profile-title">Xóa khuyến mãi Combo trưa</h1>
