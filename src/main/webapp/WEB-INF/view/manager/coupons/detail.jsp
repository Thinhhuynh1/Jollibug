          ...
          <div style="max-width:52rem; margin:0 auto; width:100%;">
            <section class="profile-content">
              <section class="profile-section">
                <h1 class="profile-title">Chi tiết mã giảm giá: ${coupon.tenMa}</h1>

                <div class="profile-form">
                  <div class="profile-grid">
                    <label class="profile-field">
                      <span>Mã giảm giá</span>
                      <input type="text" value="${coupon.tenMa}" readonly
                        style="text-transform: uppercase; font-weight: 700; color: var(--primary-color);" />
                    </label>

                    <label class="profile-field">
                      <span>Mô tả</span>
                      <input type="text" value="${coupon.moTa}" readonly />
                    </label>

                    <label class="profile-field">
                      <span>Mức giảm</span>
                      <input type="text" value="${coupon.discountDisplay}" readonly />
                    </label>

                    <label class="profile-field">
                      <span>Số lượng còn lại</span>
                      <input type="text" value="${coupon.soLuong}" readonly />
                    </label>
                    ...
                    <label class="profile-field">
                      ...
                      <input type="text" value="${coupon.ngayKetThucValue}" readonly />
                    </label>

                    <label class="profile-field">
                      <span>Trạng thái</span>
                      <input type="text" value="${coupon.status}" readonly />
                    </label>
                  </div>
                  ...
                  <div class="profile-actions"
                    ...
                    <a href="<c:url value='/manager/coupons/update?couponID=${coupon.maGG}'/>" class="profile-submit"
                      style="display:inline-flex; align-items:center; justify-content:center; text-decoration:none; max-width:180px;">Chỉnh
                      sửa</a>
                  </div>
                </div>
              </section>
