          ...
          <div style="max-width:52rem; margin:0 auto; width:100%;">
            <section class="profile-content">
              <section class="profile-section">
                ...
                <form action="<c:url value='/manager/coupons/create'/>" method="post" class="profile-form">
                  <div class="profile-grid">
                    ...
                    <label class="profile-field">
                      <span id="mucGiamLabel">Mức giảm (%)</span>
                      <input type="number" step="1" min="0" name="mucGiam" placeholder="10" required id="mucGiamInput" />
                    </label>

                    <label class="profile-field" style="grid-column: span 2;">
                      <span>Mô tả ngắn gọn</span>
                      <input type="text" name="moTa" placeholder="Ví dụ: Giảm 10% cho đơn hàng đầu tiên" required />
                    </label>

                    <label class="profile-field">
                      <span>Số lượng phát hành</span>
                      <input type="number" min="1" name="soLuong" placeholder="100" required />
                    </label>

                    <label class="profile-field">
                      <span>Điều kiện đơn tối thiểu (VNĐ)</span>
                      <input type="number" min="0" step="1000" name="dieuKien" placeholder="0 hoặc 100000" />
                    </label>
                  ...
                  <div class="profile-actions"
                    ...
                    <button type="submit" class="profile-submit" style="max-width:180px;">Lưu mã giảm giá</button>
                  </div>
                </form>
              </section>
            </section>
