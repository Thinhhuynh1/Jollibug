        ...
        <div class="panel-header">
          ...
          <div class="panel-controls">
            ...
            <div class="order-filter-strip__pills" role="tablist" aria-label="Filter by account status" style="gap:0.35rem;">
              <a href="/admin/users" class="btn btn-primary" role="tab" type="button" data-status-tab="active" id="tab-active" style="background-color: green; color: white;">
                Đang hoạt động
              </a>
              <a href="/admin/users/block" class="btn btn-primary" role="tab" type="button" data-status-tab="blocked" id="tab-blocked" style="background-color: red; color: white;">
                Bị khóa
              </a>
            </div>
            ...
            <a href="/admin/users/create" class="btn btn-primary" type="button" id="btn-add-user">
