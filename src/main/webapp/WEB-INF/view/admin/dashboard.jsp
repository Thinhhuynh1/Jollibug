...
<head>
  ...
  <title>Jollibug | Bảng điều khiển quản trị</title>
  <meta name="description" content="Bảng điều khiển quản trị Jollibug để quản lý người dùng, vai trò và trạng thái tài khoản." />
      ...
      <section class="admin-dashboard">
        <section class="admin-panel" style="margin-bottom:var(--space-6); position:relative; overflow:hidden;">
          ...
          <div class="panel-header" style="margin-bottom:0; align-items:flex-start;">
            <div class="stack" style="gap:0.45rem; max-width:42rem;">
              <h1 class="section-title" style="margin:0;">Bảng điều khiển quản trị người dùng</h1>
              <p class="muted" style="margin:0; line-height:1.65;">Theo dõi tổng quan tài khoản, trạng thái hoạt động và thao tác nhanh với người dùng. Phần doanh thu món ăn sẽ được tách sang bảng điều khiển riêng.</p>
            </div>
        ...
        <div class="metric-grid" style="margin-bottom:var(--space-6);">
          ...
          <article class="metric-card">
            ...
            <span class="metric-delta" data-tone="up">Tài khoản đang dùng</span>
          </article>
          <article class="metric-card">
            <span class="muted">Khối vận hành</span>
            <strong id="metric-ops-users">${countManager + countStaff}</strong>
            <span class="metric-delta" data-tone="info">Quản lý và nhân viên</span>
          </article>
          <article class="metric-card">
          ...
          <section class="admin-activity">
            <div class="panel-header">
              <div class="stack" style="gap:0.2rem;">
                ...
                <span class="muted">Các lối tắt phục vụ quản trị người dùng thường xuyên.</span>
              </div>
            </div>
            <div class="activity-list">
              <article class="activity-item">
                <strong>Tạo người dùng mới</strong>
                <span class="muted">Thêm tài khoản khách hàng, nhân viên hoặc quản lý.</span>
              </article>
              <article class="activity-item">
                <strong>Kiểm tra tài khoản bị khóa</strong>
                <span class="muted">Rà soát những người dùng cần mở khóa hoặc xử lý thêm.</span>
              </article>
              <article class="activity-item">
                <strong>Xem danh sách chi tiết</strong>
