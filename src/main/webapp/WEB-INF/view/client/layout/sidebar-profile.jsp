...
<aside class="profile-sidebar">
    ...
    <nav class="profile-nav" aria-label="Điều hướng tài khoản">
        ...
        <a href="${profileUrl}"<c:if test="${profileActive}"> class="is-active"</c:if>>Thông tin tài khoản</a>
        <a href="${resetPasswordUrl}"<c:if test="${resetPasswordActive}"> class="is-active"</c:if>>Đổi mật khẩu</a>
    </nav>
</aside>
