...
<head>
  ...
  <meta name="description" content="Cập nhật món trong giỏ hàng và tiếp tục đặt món" />
          ...
          <article class="cart-panel">
            <div class="cart-item-list">
              ...
              <c:forEach var="cartItem" items="${sessionScope.cart}">
                ...
                <article class="cart-line" id="cart-line-${cartItem.maMon}" data-price="${cartItem.donGia}">
                  <div class="cart-line__thumb">
                    <img src="/images/${cartItem.imageUrl}" alt="${cartItem.tenMon}" style="width: 100%; height: 100%; object-fit: cover; border-radius: 10px;" />
                  </div>
                  ...
                  <div class="cart-line__meta">
                    ...
                    <div class="cart-line__controls">
                      <a class="cart-link-btn" href="#" data-action="remove" onclick="removeCartItem(event, ${cartItem.maMon})">
                        Xóa
                      </a>

                      <div class="cart-line__purchase">
                        <div class="qty-stepper" aria-label="Chỉnh số lượng">
                          <button class="qty-stepper__btn" type="button" aria-label="Giảm số lượng" onclick="changeQuantity(${cartItem.maMon}, -1)">
                            -
                          </button>
                          ...
                          <button class="qty-stepper__btn" type="button" aria-label="Tăng số lượng" onclick="changeQuantity(${cartItem.maMon}, 1)">
                            +
                          </button>
                        </div>
