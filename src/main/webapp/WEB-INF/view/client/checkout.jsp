    ...
    <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
      ...
      <head>
        ...
        <meta name="description"
          content="Jollibug checkout page: review order details, choose delivery address, apply voucher, and place your order." />
            ...
            <div class="checkout-layout">
              <section class="checkout-card">
                ...
                <section class="invoice-box" aria-label="Invoice summary">
                  ...
                  <div class="invoice-line"><span>Delivery Fee</span><strong id="invoice-delivery-fee">0 VND</strong>
                  </div>
                  <div class="invoice-line"><span>Discount / Voucher</span><strong id="invoice-discount">0 VND</strong>
                  </div>
                  <div class="invoice-line invoice-line--total"><span>Total</span><strong id="invoice-total">0
                      VND</strong></div>
                </section>
              </section>
              ...
              <section class="checkout-card checkout-sticky">
                ...
                <button class="btn btn-outline" type="button" id="btn-open-address-modal">Choose another
                  address</button>
