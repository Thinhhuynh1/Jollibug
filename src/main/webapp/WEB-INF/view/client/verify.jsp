  ...
  <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
      ...
      <head>
        ...
        <meta name="description" content="Xác thực tài khoản Jollibug của bạn." />
              ...
              <article class="auth-panel reveal-up">
                <div class="auth-panel__content">
                  <div class="page-intro" style="margin-bottom:0;">
                    ...
                    <p style="color: #666; font-size: 0.95rem; margin-top: 10px;">Vui lòng nhập mã xác thực đã được gửi
                      đến email của bạn để tiếp tục.</p>
                  </div>
                  ...
                  <c:if test="${not empty message}">
                    <div
                      style="background-color: #f8fff9; border: 1px solid #e1f5e5; color: #1e7e34; padding: 12px; border-radius: 4px; margin-bottom: 15px; margin-top: 15px;">
                      ${message}
                    </div>
                  </c:if>
                  ...
                  <form action="/verify/resend" method="POST" style="margin-top: 12px;">
                    <button class="btn btn-secondary btn-block" type="submit">Gửi lại mã khác</button>
                  </form>
